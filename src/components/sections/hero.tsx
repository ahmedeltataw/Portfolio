  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
        ...
        <p className="hero-subtitle mb-6 inline-flex items-center gap-2.5 rounded-full glass-strong px-5 py-2 text-xs font-medium tracking-[0.15em] uppercase">
      ...
      <div className="hero-scroll absolute bottom-8 flex flex-col items-center gap-2 text-muted-foreground/50">
